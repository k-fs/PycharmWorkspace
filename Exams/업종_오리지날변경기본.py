...
#                    self.tradeAek, self.listedStock, self.junga ) )
            print("insert into oms9jj (eToDate, eStockCode, eStockname, eNujucksu, eNujuckaek, eSangJangSu, eHyunJaeGa, eJunilGa, eJunilDaebi ) values ('%s', '%s', '%s', %s, %s, %s, %s, %s, %s);"
                  % (today, self.code, self.name, self.vol, self.tradeAek, self.listedStock, self.cur, self.junga, self.diff ))
...
#            try:
#                curs.execute("insert into oms9jj (eToDate, eStockCode, eStockname, eNujucksu, eNujuckaek, eSangJangSu, eHyunJaeGa, eJunilGa, eJunilDaebi ) values ('%s', '%s', '%s', %s, %s, %s, %s, %s, %s)"
